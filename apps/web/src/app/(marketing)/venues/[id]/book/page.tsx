    ...
    <div className="min-h-screen">
      <div className="container max-w-7xl pb-component pt-28 md:pt-32">
        ...
        {!isLoadingApiData && courts.length === 0 && (
          <div className="body-sm mb-5 rounded-xl border border-white/[0.06] bg-white/[0.03] px-4 py-3 text-[#F7F7F7]/60">
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-[#0C1B26] p-5 md:p-6 space-y-8 divide-y divide-white/[0.06]">
            ...
            <div className="pt-0">
              <div className="flex items-center gap-3">
                <div className="caption flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#50C8C8]/20 text-[#50C8C8]">
                  1
                </div>
            ...
            <div className="pt-8">
              ...
              <div className="mt-2 flex items-center justify-between sm:hidden">
                <button
                  ...
                  disabled={dateScrollStart === 0}
                  className="label flex items-center gap-1 text-[#F7F7F7]/25 disabled:opacity-20 disabled:cursor-not-allowed"
                >
            ...
            <div className="pt-8">
              ...
              <div className="mt-3 flex items-center gap-4">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="caption text-[#F7F7F7]/25">Selected</span>
                </div>
                <div className="flex items-center gap-1.5">
            ...
            <div className="h-full">
              <div className="rounded-2xl border border-white/[0.06] bg-[#0C1B26] p-6 h-full flex flex-col">
                ...
                <div className="mt-5 space-y-4">
                  <div className="flex items-center justify-between">
                    <span className="body-sm text-[#F7F7F7]/40">Venue</span>
                    <span className="label text-[#F7F7F7]/80">
                      {venue?.name ?? "—"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="body-sm text-[#F7F7F7]/40">Court</span>
                    <span className="label text-[#F7F7F7]/80">
                      {selectedCourt?.name ?? "—"}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="body-sm text-[#F7F7F7]/40">Date</span>
                    <span className="label text-[#F7F7F7]/80">
                      {formatBookingDate(selectedDate)}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="body-sm text-[#F7F7F7]/40">Time</span>
                    <span className="label text-[#F7F7F7]/80">
                      {selectedSlots.length > 0
                  ...
                  {appliedVoucher ? (
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        ...
                        className="label rounded-xl bg-white/[0.06] px-4 py-2 text-[#F7F7F7]/80 hover:bg-white/[0.1] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                      >
