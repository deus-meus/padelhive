    ...
    <div className="min-h-screen pt-20">
      <div className="container max-w-2xl py-8">
        ...
        <div className="mt-6 rounded-xl border border-white/[0.06] bg-[#0C1B26] p-4">
          <div className="body-sm flex flex-wrap items-center gap-x-4 gap-y-1 text-[#F7F7F7]/60">
            <span>{venue}</span>
        ...
        <div className="mt-8">
          ...
          <div className="mt-3 flex flex-col gap-3 sm:flex-row sm:items-center">
            <div className="flex min-w-0 flex-1 items-center rounded-xl border border-white/[0.06] bg-white/[0.02] px-4 py-3">
              <span className="body-sm flex-1 truncate text-[#F7F7F7]/60">
                {firstInviteLink}
              </span>
            </div>
            <button
              ...
              disabled={!invites[0]}
              className={`label flex h-[46px] items-center justify-center gap-2 rounded-xl border px-5 transition-all disabled:cursor-not-allowed disabled:opacity-30 ${
        ...
        <div className="mt-8">
          ...
          <div className="mt-3 flex items-center gap-3">
            <input
              ...
              className="body flex-1 rounded-xl border border-white/[0.06] bg-white/[0.02] px-4 py-3 text-[#F7F7F7] placeholder:text-[#F7F7F7]/25 focus:border-[#E6FA50]/30 focus:outline-none focus:ring-1 focus:ring-[#E6FA50]/20 disabled:cursor-not-allowed disabled:opacity-50"
            />
            <button
          ...
          {successMessage && (
            <div className="mt-3 rounded-xl border border-green-400/20 bg-green-400/10 p-3">
              <p className="caption text-green-200/80">{successMessage}</p>
            </div>
          )}
          {submitError && (
        ...
        <div className="mt-8">
          <div className="flex items-center justify-between">
            ...
            <span className="caption text-green-400/70">
            ...
            {isLoading ? (
              ...
              invites.map((invite) => {
                ...
                return (
                  ...
                  >
                    <div className="flex min-w-0 items-center gap-3">
                      <div className="body flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#50C8C8]/10 font-semibold uppercase text-[#50C8C8]">
                        {invite.name.slice(0, 1)}
                      </div>
                      <div className="min-w-0">
                        <p className="body-sm truncate text-[#F7F7F7]/80">
                          {invite.name}
                        </p>
                        <p className="caption truncate text-[#F7F7F7]/25">
                          {invite.email}
                        </p>
                      </div>
                    </div>
