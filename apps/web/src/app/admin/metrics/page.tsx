...
export default function AdminMetricsPage() {
  ...
  const totalStatusCount = data.statusBreakdown.reduce(
    (sum, s) => sum + s.count,
    0,
  );
                ...
                {data.monthlySeries.map((m) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      />
                      <p className="caption mt-3 text-[#F7F7F7]/40">
                        {monthName}
                      </p>
          ...
          <div className="rounded-2xl border border-white/[0.06] bg-[#0C1B26] p-6">
            ...
            <div className="space-y-5">
              {data.statusBreakdown.map((s) => {
                const pct =
                  totalStatusCount > 0 ? (s.count / totalStatusCount) * 100 : 0;
                return (
                  <div key={s.status}>
                    ...
                    <div className="h-2 w-full overflow-hidden rounded-full bg-white/[0.04]">
                      <div
                        className="h-full bg-[#E6FA50] transition-all"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
                  </div>
